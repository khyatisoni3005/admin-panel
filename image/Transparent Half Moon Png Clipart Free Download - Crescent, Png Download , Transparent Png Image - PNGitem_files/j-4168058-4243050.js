//Generated:2023-09-04 08:01:38// 6-274
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4168058 || '',
    guid: window.ftGUID_4168058 || '',
    confID: window.ftConfID_4168058 || '0',
    ftReturn: window.ftReturn_4168058 || '',
    keyword: window.ftKeyword_4168058 || '',
    ftId: window.ftId_4168058 || '',
    ftImpId: window.ftImp4168058 && window.ftImp4168058.impID || '',
    gdpr: window.ftImp4168058 && window.ftImp4168058.gdpr || '',
    gdpr_consent: window.ftImp4168058 && window.ftImp4168058.gdpr_consent || '',
    gdpr_pd: window.ftImp4168058 && window.ftImp4168058.gdpr_pd || '',
    us_privacy: window.ftImp4168058 && window.ftImp4168058.us_privacy || '',
    campaignID: '115751',
    cID: '116264',
    pID: '4168058',
    creativeID: '4243050',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115751&sid=18330&plc=4168058&num=&adid=&advid=&adsrv=29&btreg=4168058&btadsrv=flashtalking&crt=4243050&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115751;4168058;4243050;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/in/acrobat/free-trial-download.html?sdid=X6FJHM6D&mv=display&mv2=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?225479428-4168058;4243050;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/416/4168058/4243050/image/4243050.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115751;4168058;202;pixel;DV360;DV360FY20AcrobatCTXCustomIntentHighReachINDSKBAN728x90/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115751;4168058;4243050;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/in/acrobat/free-trial-download.html?sdid=X6FJHM6D&mv=display&mv2=display",
    divID: 'ftdiv4168058',
    altimgID: 'ftalt4168058',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4168058 && parseInt(window.ftImp4168058.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4168058') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4168058'),
    pageVisible: 'maybe',
...
(function(o) {
    ...
    o.frameID = 'ftframe4168058';
    o.file = 'http://cdn.flashtalking.com/116264/4243050/index.html';
    o.altImg = 'https://servedby.flashtalking.com/imp/8/115751;4168058;204;gif;DV360;DV360FY20AcrobatCTXCustomIntentHighReachINDSKBAN728x90/?';
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4168058").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4168058").style.display = "none";
		    }
		});
	}
}(ft4168058));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115751&l2=DV360&l3=4168058&l4=4243050&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115751&l2=DV360&l3=4168058&l4=4243050&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4168058;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4168058;
